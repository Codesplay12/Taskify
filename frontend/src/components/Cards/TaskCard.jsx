...
return "text-rose-500 bg-rose-50 border border-rose-500/10";
  ...
  return <div 
         ...
         onClick={onClick}
         >
          <div className='flex items-end g3 px-4'>
            <div className={`text-[11px] font-me ${getStatusTagColor()} px-4 py-0.5 rounded`}>
              {status}
            </div>
            <div className={`text-[11px] font-me ${getPriorityTagColor()} px-4 py-0.5 rounded`}>
              {priority} Priority
            </div>
          </div> 
          <div
